...
// --- Efficiency: Optimized Inline SVGs (No external dependencies) ---
const Icons = {
...
// --- Efficiency: Memoized List Item (Prevents re-renders) ---
...
function Setting() {
  ...
  // --- Grouped Data for cleaner rendering ---
      ...
      <div className="profile-header">
        <div className="avatar-wrapper">
          <img 
            ...
            loading="lazy" /* Efficiency: Lazy load image */
          />
          <button className="edit-avatar-btn"><Icons.Edit /></button>
        </div>
        <div className="profile-info">
          <h2 className="profile-name">นักศึกษา มธ.</h2>
          <p className="profile-email">student@dome.tu.ac.th</p>
          <span className="profile-status">นักศึกษาปริญญาตรี</span>
        </div>
      </div>
